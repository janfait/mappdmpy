...
class MappDmp:
   ...
   def check_export_status(export_id=None):
       response = self.list_exports()
       
   def prepare_query(dimensions,measures,filters,limit):
       query = {}
   ...
   def validate_measures(self,input=None):
       if not input:
           return self.dictionary['measures']
       else:
   ...
   def validate_dimensions(self,input=None):
      if not input:
          return self.dictionary['dimensions']
      else:
   ...
   def validate_filters(self,input):
       if not input:
           return self.dictionary['filters']
       else:
           return input
